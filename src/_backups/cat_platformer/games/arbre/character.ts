...
export default class Character extends Bodies.Mobility {
  ...
  constructor(){
    ...
    this.backtoidle = new Time.Timeout([
      (this.changeframe.ms[0]*(this.character.sword[0].frames.length-1)),
      (this.changeframe.ms[0]*(this.character.sword[1].frames.length-1)),
      (this.changeframe.ms[0]*(this.character.sword[2].frames.length-1)),
      (this.changeframe.ms[0]*(this.character.sword[3].frames.length-1))],"backtoidle",false)
  ...
  private slash(){
    ...
    // console.log(backtoidle)
          Assets.playSound('_assets/swoosh_1.wav');
    ...
    let hurtpos = [
      //up
      {x:this.pos.x,y:this.pos.y-32,w:32,h:32},
      //left
      {x:this.pos.x-32,y:this.pos.y,w:32,h:32},
      //down
      {x:this.pos.x,y:this.pos.y+32,w:32,h:32},
      //right
      {x:this.pos.x+32,y:this.pos.y,w:32,h:32}
    ]
    Physics.collisionpool.push(new Capture(C.CollideLayers.player,C.CollideLayers.npc,C.CollideTypes.hurt,this,hurtpos[this.dir],
      (owner,target) => {
