...
export default class GaniYan {
  ...
  constructor(){
    this.idle = GaniParser.parse(Assets.getText("_assets/idle.gani")).animations;
    this.walk = GaniParser.parse(Assets.getText("_assets/walk.gani")).animations;
    this.sword = GaniParser.parse(Assets.getText("_assets/sword.gani")).animations;
