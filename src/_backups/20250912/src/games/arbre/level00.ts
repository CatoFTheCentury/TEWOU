...
export default class GameLevel extends Incarnations.Level{
  ...
  public async build(game: Games):Promise<void>{
    ...
    this.physics.collisionpool.push(new CollisionGrid(game.cellbuild.collisions[0], 16, C.CollideLayers.player, C.CollideTypes.block));
