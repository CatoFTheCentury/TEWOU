...
export default class GaniYan {
  ...
  constructor(){
    this.idle = GaniParser.parse(Assets.getText("_assets/arduboy/idle.gani")).animations;
    this.walk = GaniParser.parse(Assets.getText("_assets/arduboy/walk.gani")).animations;
    this.sword = GaniParser.parse(Assets.getText("_assets/arduboy/sword.gani")).animations;
