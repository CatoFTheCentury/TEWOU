...
export default class Normal extends Shader {
    ...
    public first : Array<()=>void> = [
      ...
      public passes : Array<(cmp: Composite.Renderable, plane: T.Box)=>void> = [
        ...
        if(cmp.rprops.rotcenter!=undefined){
          ...
          let rotcenter : T.Point = {x:cmp.rprops.pos.x,y:cmp.rprops.pos.y}
          // console.log(cmp.rprops.rotcenter.y)
          // rotate around center? Image bobs up and down
          // funtimes =  Matrix.translate(funtimes,-rotcenter.x,-rotcenter.y,0);
          funtimes = Matrix.mat4mul(funtimes,Matrix.mat4translation({x:-rotcenter.x,y:-rotcenter.y})) as Float32Array<ArrayBuffer>;
          funtimes = Matrix.mat4mul(funtimes,Matrix.mat4rot(cmp.rprops.angle)) as Float32Array<ArrayBuffer>;
          // funtimes = Matrix.rotation(funrtime)
          // funtimes =  Matrix.translate(funtimes,rotcenter.x,rotcenter.y,0);
